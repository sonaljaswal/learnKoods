...
const MainJobSection = () => {
  ...
  return (
    <div className='flex md:flex-row flex-col px-[7%] gap-x-7 sm:mt-14 sm:mb-14 mt-7 mb-7'>
      ...
      {jobs.length == 0 ?
        <div className='md:w-[65%]  w-[100%] h-[50vh]  flex items-center justify-center'>
          <div className='flex items-center justify-center '>
            <div role="status flex items-center justify-center w-full ">
              <svg
                aria-hidden="true"
                className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 flex  items-center"
                viewBox="0 0 100 101"
                fill="none"
